# Contributing to handlebars-helper-each

First and foremost, thank you! We appreciate that you want to contribute to handlebars-helper-each, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for handlebars-helper-each**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for handlebars-helper-each:

- star the [project](https://github.com/jonschlinkert/handlebars-helper-each)
- tweet your support for handlebars-helper-each
...
- **version**: please note the version of handlebars-helper-each are you using
...
[so]: http://stackoverflow.com/questions/tagged/handlebars-helper-each